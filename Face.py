...
from datasetLoader import ImageTensorDataset  

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")


train_dataset = ImageTensorDataset("\Materi semester 6\Deep Learning\Tugas2B\Dataset\TRAINING")  
...
torch.save(model.state_dict(), "trained_model.pth")  # Save the model's state dict
